  ...
  return (
    <>
      <button onClick={() => setOpen(true)} className={'group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition'}>
        ...
        <kbd className=" pointer-events-none flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[11px] font-medium text-muted-foreground ml-auto">
          <span className="text-[9.7px]">⌘</span>K
        </kbd>
      </button>
